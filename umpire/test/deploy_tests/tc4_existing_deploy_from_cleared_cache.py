        ...
        "items":[
            {
                ...
                "version":"test",
                "platform":"test",
                "destination":"$tc4/testA"
            },
            {
                "name":"test",
                "version":"test",
                "platform":"test",
                "destination":"$tc4/testB"
            }
        ]
    }
]
...
class TC4(unittest.TestCase):
    ...
    tempdir = os.path.join(tempfile.gettempdir(), "tc4")
    cache_root = os.path.join(tempdir,"./tc4_cache")
    deployment_file = os.path.join(tempdir,"./tc4_deploy")
    environment_variables = { "tc4" : os.path.join(tempdir,"deployment") }
